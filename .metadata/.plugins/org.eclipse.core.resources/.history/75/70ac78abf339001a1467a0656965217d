...
public class Sparql 
{
	...
	public static String sparqlMorpho(String querySequence) throws IOException {
        ...
        System.out.println(querySequence + " appartient au groupe morphologique : " + retMorphoGroup);
	...
	static String compareWordAndQuery(String wordToCompare) throws IOException {
		...
		// si le mot renseigné est similaire à un autre dans le vocabulaire on l'utilise
		// sinon on garde celui rentré par l'utilisateur
		if (!(SearchWord.searchWord(wordToCompare).isEmpty())) {			
